...
import { useAddressPoolPayment } from '@/modules/address-pool-payments/hooks/useAddressPoolPayment'
...
export default function Table() {
  const { data, isLoading } = useAddressPoolPayment()
