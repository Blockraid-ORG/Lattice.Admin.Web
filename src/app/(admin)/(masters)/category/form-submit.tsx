...
export function FormSubmit({ data }: { data?:TCategory }) {
  const [dialog, setDialog] = useState(false)
  const { mutate: create, isPending: updating } = useCreateCategory()
              ...
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-3">
                <div className="grid grid-cols-1 gap-3">
                  ...
                  <FormSelect
                    ...
                    control={form.control}
                    options={categoryFrequency}
                  />
                  <FormInput
                    placeholder="targetYield"
                    label="Target Yield" name={"targetYield"}
                    control={form.control}
                  />
                  <FormInput
